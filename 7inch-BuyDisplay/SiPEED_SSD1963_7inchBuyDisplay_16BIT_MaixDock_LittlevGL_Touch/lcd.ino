...
void LCD_SetWindow(uint16_t x1, uint16_t y1, uint16_t x2, uint16_t y2) {
  write_command(0x002A);  
  Write_Data_Register(x1>>8);      
  Write_Data_Register(x1&0x00ff);
  Write_Data_Register(x2>>8);      
  Write_Data_Register(x2&0x00ff);
  
  write_command(0x002b);  
  Write_Data_Register(y1>>8);      
  Write_Data_Register(y1&0x00ff);
  Write_Data_Register(y2>>8);      
  Write_Data_Register(y2&0x00ff);
